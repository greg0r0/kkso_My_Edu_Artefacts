...
namespace ECC {
    ...
    class EllipticCurve
    {
        ...
        */
        ...
        EllipticCurve(T _a, T _b, T _modulo) : a(_a), b(_b), modulo(_modulo), G( true ), n(nullptr), h(nullptr){}
        ...
        bool CheckPoint(ECC::EllipticPoint<T> point){
            ...
            T right_row = boost::multiprecision::powm(point.getX(), 3, this->modulo) + this->a*point.getX()+this->b;
            T right = Util::Math<T>::mod(right_row, this->modulo);
